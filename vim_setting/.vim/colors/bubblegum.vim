...
" (see `:h w18`)
"
hi Normal          ctermfg=249    ctermbg=233    cterm=none    guifg=#B2B2B2    guibg=#303030    gui=none
hi Comment         ctermfg=244    guifg=#808080

" yellow
hi Constant        ctermfg=214    guifg=#D7D787
hi String          ctermfg=215    guifg=#D7D7AF
hi Character       ctermfg=215    guifg=#D7D7AF
hi Number          ctermfg=221    guifg=#D7AF5F
hi Boolean         ctermfg=215    guifg=#D7D7AF
hi Float           ctermfg=221    guifg=#D7AF5F
...
" minor groups
"
hi StatusLine      ctermfg=fg     ctermbg=234    cterm=none    guifg=fg    guibg=#3A3A3A    gui=none
hi StatusLineNC    ctermfg=244    ctermbg=234    cterm=none    guifg=#808080    guibg=#3A3A3A    gui=none
hi TabLine         ctermfg=fg     ctermbg=234    cterm=none    guifg=fg    guibg=#3A3A3A    gui=none
hi TabLineSel      ctermfg=253    ctermbg=235    cterm=none    guifg=#DADADA    guibg=#444444    gui=none
hi TabLineFill     ctermfg=fg     ctermbg=234    cterm=none    guifg=fg    guibg=#3A3A3A    gui=none

hi Pmenu           ctermfg=fg     ctermbg=234    guifg=fg    guibg=#3A3A3A
...
hi WildMenu        ctermfg=71     ctermbg=234    cterm=none    guifg=#5FAF5F    guibg=#3A3A3A    gui=none

hi Visual          ctermfg=bg     ctermbg=117    guifg=bg    guibg=#87D7FF
hi VisualNOS       ctermfg=bg     ctermbg=116    guifg=bg    guibg=#87D7D7
hi VertSplit       ctermfg=244    ctermbg=234    cterm=none    guifg=#808080    guibg=#3A3A3A    gui=none
hi LineNr          ctermfg=244    ctermbg=234    guifg=#808080    guibg=#3A3A3A
...
hi Search          ctermfg=16     ctermbg=221     cterm=none    guifg=#000000    guibg=#D7AF5F    gui=none
...
hi FoldColumn      ctermfg=79     ctermbg=234    guifg=#5FD7AF    guibg=#3A3A3A
hi SignColumn      ctermfg=79     ctermbg=234    guifg=#5FD7AF    guibg=#3A3A3A
hi ColorColumn     ctermfg=79     ctermbg=234    guifg=#5FD7AF    guibg=#3A3A3A

hi CursorColumn    ctermbg=234    cterm=none    guibg=#3A3A3A    gui=none
hi CursorLine      ctermbg=234    cterm=none    guibg=#3A3A3A    gui=none
...
hi diffChanged     ctermfg=221    guifg=#D7AF5F
